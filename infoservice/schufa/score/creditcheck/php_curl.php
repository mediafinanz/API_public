<?php
/**
 * PHP Beispiel - Schufa Bonitätsauskunft
 ...
 * Schufa Bonitätsanfrage an die mediaFinanz REST API v2.1
 * @see https://api.mediafinanz.de/docs/v2.1/schufa_response_score_creditcheck/
 */
$sJsonBody = '{
  "Order": {
...
$rCurl = curl_init();
curl_setopt($rCurl, CURLOPT_URL, 'https://test.api.mediafinanz.de/v2.1/infoservice/schufa/score/creditcheck/');
