<?php
/**
 * PHP Beispiel - Crif Bonitätsauskunkt (Produkt ConCheckPlusIdent)
...
$rCurl = curl_init();
curl_setopt($rCurl, CURLOPT_URL, 'https://test.api.mediafinanz.de/v2.1/infoservice/crif/score/concheckplusident/');
